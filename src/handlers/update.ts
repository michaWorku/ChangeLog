...
export const getUpdates = async (req: Request & { user: Partial<User> }, res: Response, next: NextFunction) => {
    try {
...
// Create an update
export const createUpdate = async (req: Request & { user: Partial<User> }, res: Response, next: NextFunction) => {
    try {
...
// Update an update
export const updateUpdate = async (req: Request & { user: User }, res: Response, next: NextFunction) => {
    try {
